...
def home(request):
    ...
    if buyer is not None or seller is not None:  # Allow both buyers and sellers
        if request.method == "GET":
            ...
            # Ensure to check buyer or seller is not None before using it
            if buyer is not None:
                # Your existing code for handling buyer actions
                pass
            elif seller is not None:
                # Your existing code for handling seller actions
                pass
            # Since this is a POST request, we need to return an appropriate response
            # In this case, let's redirect to the home page
            return redirect('home')
    else:
        return HttpResponse("You need to be a buyer or seller to access this page.")
